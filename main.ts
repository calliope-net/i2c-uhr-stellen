...
function zeigeControlRegister () {
    ...
    lcd16x2rgb.writeText(lcd16x2rgb.lcd16x2_eADDR(lcd16x2rgb.eADDR_LCD.LCD_16x2), 1, 10, 14, lcd16x2rgb.lcd16x2_text(bit.formatNumber(rtcpcf85063tp.readRegister(rtcpcf85063tp.rtcpcf85063tp_eADDR(rtcpcf85063tp.eADDR.RTC_x51), rtcpcf85063tp.eControl.RAM_byte), bit.eLength.HEX_FF)))
    lcd16x2rgb.writeText(lcd16x2rgb.lcd16x2_eADDR(lcd16x2rgb.eADDR_LCD.LCD_16x2), 0, 13, 14, lcd16x2rgb.lcd16x2_text(bit.formatNumber(rtcpcf85063tp.readRegister(rtcpcf85063tp.rtcpcf85063tp_eADDR(rtcpcf85063tp.eADDR.RTC_x51), rtcpcf85063tp.eControl.Offset), bit.eLength.HEX_FF)))
    lcd16x2rgb.writeText(lcd16x2rgb.lcd16x2_eADDR(lcd16x2rgb.eADDR_LCD.LCD_16x2), 0, 9, 11, bit.sign(rtcpcf85063tp.readRegister(rtcpcf85063tp.rtcpcf85063tp_eADDR(rtcpcf85063tp.eADDR.RTC_x51), rtcpcf85063tp.eControl.Offset), 6))
}
function initRGB () {
